...
from curvo import evaluator_tier0 as ev_mod
from curvo import players as players_mod
from validation.realdata import orchestration_schematic as os_
...
def render(out_path="picalm_orchestration.png"):
    rows = _ladder_rows()
...
if __name__ == "__main__":
    render()
    print("wrote picalm_orchestration.png")